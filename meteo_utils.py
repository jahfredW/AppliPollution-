...
def construire_affichage_nh3(ville):
    ...
    previsions['j1'] = str(pollution.get_nh3(ville, POLLUTION_J_PLUS_1))
    previsions['j2'] = str(pollution.get_nh3(ville, POLLUTION_J_PLUS_2))
    previsions['j3'] = str(pollution.get_nh3(ville, POLLUTION_J_PLUS_3))
    previsions['j4'] = str(pollution.get_nh3(ville, POLLUTION_J_PLUS_4))
    previsions['j5'] = str(pollution.get_nh3(ville, POLLUTION_J_PLUS_5))
    previsions['j6'] = "None"
    previsions['j7'] = "None"
...
def construire_affichage_pm10(ville):
    ...
    previsions['j1'] = str(pollution.get_pm10_j5(ville, POLLUTION_J_PLUS_1))
    previsions['j2'] = str(pollution.get_pm10_j5(ville, POLLUTION_J_PLUS_2))
    previsions['j3'] = str(pollution.get_pm10_j5(ville, POLLUTION_J_PLUS_3))
    previsions['j4'] = str(pollution.get_pm10_j5(ville, POLLUTION_J_PLUS_4))
    previsions['j5'] = str(pollution.get_pm10_j5(ville, POLLUTION_J_PLUS_5))
    previsions['j6'] = "None"
    previsions['j7'] = "None"
...
def construire_affichage_co(ville):
    ...
    previsions['j1'] = str(pollution.get_co(ville, POLLUTION_J_PLUS_1))
    previsions['j2'] = str(pollution.get_co(ville, POLLUTION_J_PLUS_2))
    previsions['j3'] = str(pollution.get_co(ville, POLLUTION_J_PLUS_3))
    previsions['j4'] = str(pollution.get_co(ville, POLLUTION_J_PLUS_4))
    previsions['j5'] = str(pollution.get_co(ville, POLLUTION_J_PLUS_5))
    previsions['j6'] = "None"
    previsions['j7'] = "None"
...
def construire_affichage_pm25(ville):
    ...
    previsions['j1'] = str(pollution.get_pm25_j5(ville, POLLUTION_J_PLUS_1))
    previsions['j2'] = str(pollution.get_pm25_j5(ville, POLLUTION_J_PLUS_2))
    previsions['j3'] = str(pollution.get_pm25_j5(ville, POLLUTION_J_PLUS_3))
    previsions['j4'] = str(pollution.get_pm25_j5(ville, POLLUTION_J_PLUS_4))
    previsions['j5'] = str(pollution.get_pm25_j5(ville, POLLUTION_J_PLUS_5))
    previsions['j6'] = "None"
    previsions['j7'] = "None"
...
def construire_affichage_aqi(ville):
    ...
    previsions['j1'] = str(pollution.get_aqi(ville, POLLUTION_J_PLUS_1))
    previsions['j2'] = str(pollution.get_aqi(ville, POLLUTION_J_PLUS_2))
    previsions['j3'] = str(pollution.get_aqi(ville, POLLUTION_J_PLUS_3))
    previsions['j4'] = str(pollution.get_aqi(ville, POLLUTION_J_PLUS_4))
    previsions['j5'] = str(pollution.get_aqi(ville, POLLUTION_J_PLUS_5))
    previsions['j6'] = "None"
    previsions['j7'] = "None"
