...
def draw_graph(ville, pol):
    ...
    if pol == 1:
        ...
        for x in range(0, 97, 24):
            data2.append(pollution.get_pm25_j5(ville, x))
        data2.append(pollution.get_pm25_j5(ville, 98))
    ...
    for row in range(n_rows):
        ...
        plt.bar(index[row]+ 0.5, data2[row], bar_width, bottom=y_offset, color='indianred')
    ...
    plt.xticks([0, 1, 2, 3, 4, 5], [days[today.isoweekday() - 1], days[j_1.isoweekday() -1]
